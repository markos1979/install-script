...
sudo apt-get -y install terminator htop git subversion wipe android-tools-adb mysql-client sqlitebrowser python-mysql.connector php5-cli curl sleuthkit keepnote chromium-browser wine pinta sshfs build-essential libssl-dev ant gdb indicator-multiload libgtk2.0-0:i386 gparted wireshark p7zip-full mercurial python-pip wipe dcfldd openvpn network-manager-openvpn nasm ascii golang-go exfat-utils
